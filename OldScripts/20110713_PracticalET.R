...
write.csv(Moree.data,paste("pracdata2010/",today,"_MoreeETout.csv",sep=""),row.names=FALSE)
...
# define the legend text
lgd.txt <- c("Trees", "Grass")
# First part is "position" next is "text" next is line and point types etc.
legend("bottomright", lgd.txt, pch=c(1,2), col=c("black", "red"))
